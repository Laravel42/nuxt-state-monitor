...
declare module '@nuxt/schema' {
  interface NuxtOptions {
     ...
     */
    ["nuxtStateMonitor"]: typeof import("./../../../src/module").default extends NuxtModule<infer O> ? O : Record<string, any>
    /**
  ...
  interface NuxtConfig {
     ...
     * Configuration for `./../../../src/module`
     */
    ["nuxtStateMonitor"]?: typeof import("./../../../src/module").default extends NuxtModule<infer O> ? Partial<O> : Record<string, any>
    /**
     * Configuration for `@nuxt/devtools`
     */
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["@nuxtjs/google-fonts", Exclude<NuxtConfig["googleFonts"], boolean>] | ["@nuxtjs/tailwindcss", Exclude<NuxtConfig["tailwindcss"], boolean>] | ["@nuxtjs/color-mode", Exclude<NuxtConfig["colorMode"], boolean>] | ["nuxt-headlessui", Exclude<NuxtConfig["headlessui"], boolean>] | ["./../../../src/module", Exclude<NuxtConfig["nuxtStateMonitor"], boolean>] | ["@nuxt/devtools", Exclude<NuxtConfig["devtools"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
}
declare module 'nuxt/schema' {
  interface NuxtOptions {
