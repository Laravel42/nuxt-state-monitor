...
<template>
    ...
    <div
        ...
        <div
            class="flex flex-col h-full shadow-md min-w-[90vw] w-[90vw] sm:min-w-[530px] sm:w-[530px] max-w-[70vw] resize-x py-4 px-2 overflow-y-auto dark:bg-zinc-900 bg-white dark:text-white">
            <div>
                <!-- Top Header -->
            ...
            <div v-if="additionalData && Object.keys(additionalData).length > 0">
